  ...
  class RosGstCapture: public rclcpp::Node 
  {
    public:
      ...
      : Node("audio_capture")
      {
        ...
        RCLCPP_INFO_STREAM(this->get_logger(), "STARTED AUDIO CAPTURE");
        ...
        this->declare_parameter<std::string>("dst", "/tmp/output.mp3");
        ...
        RCLCPP_INFO_STREAM(this->get_logger(), "Input device set to " << device.c_str());
